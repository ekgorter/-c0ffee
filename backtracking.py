...
def landen_kleuren(landen, kleuren):
    ...
    while i in range(len(landen)):
        ...
        # Verwijder de kleur van het huidige land uit de tijdelijke kleuren lijst, als dit land een kleur heeft.
        #try:
            #temp.pop(temp.index([land for land in landen if land.naam == landen[i].naam][0].kleur))
        ...
        # Als er geen kleuren meer mogelijk zijn.
            ...
            # Verwijder de kleur van het huidige land.
            #landen[i].kleur = 'geen'

            # Backtrack naar vorige land
            #i -= 1
